...
class _AdminScreenState extends State<AdminScreen> {
  ...
  Color _roleColor(String role) {
    switch (role.toLowerCase()) {
      ...
      case 'vendor': return Colors.orangeAccent;
      default: return const Color(0xFF00D4A8);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SharedAppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.refresh_rounded, color: Color(0xFF00D4A8)),
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFF00D4A8).withOpacity(0.1),
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.search_rounded,
                          color: Color(0xFF00D4A8), size: 20),
                      filled: true,
                      ...
                      focusedBorder: OutlineInputBorder(
                        ...
                        borderSide: const BorderSide(
                            color: Color(0xFF00D4A8), width: 1.5),
                      ),
                      contentPadding:
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: isMe
                                      ? const Color(0xFF00D4A8).withOpacity(0.4)
